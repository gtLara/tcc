...
def sucata_current_signal_acorrs(color, dpi, image_path, extension):
    ...
    series_figure.suptitle("Visualizações de Autocorrelações de Correntes sob " + \
                           "Regime Anômalo", size=17)
