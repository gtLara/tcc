...
\begin{document}
    ...
    \input{text/2-textuais/2-teoria_classica_st}
	\input{text/2-textuais/3-teoria_classica_ssp}
	\input{text/2-textuais/4-aplicacoes}
	\input{text/2-textuais/5-conclusao}
