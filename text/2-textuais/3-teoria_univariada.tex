...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/moving_average.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/loess.png}
    \caption{Visualização de algoritmo LOESS}
    \label{fig:loess}
\end{figure}

\subsection{Modelagem de Sazonalidade(Ajuste de Sazonalidade)}\label{ssec:mean_season}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ma_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ma_corr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ar_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ar_corr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21_pzp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21_integrated.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21_integrated_pzp.png}
    \caption{Visualização de posicionamento de polos e zeros de processo
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21_diff.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/arma_21_diff_pzp.png}
    \caption{Visualização de posicionamento de polos e zeros de processo
