...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/white_noise.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/trend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/log_trend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/seasonality.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/add_seasonality.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/mult_seasonality.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/corr_trend.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/corr_seasonality.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/noisy_seasonal_signal.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/stationarity_examples.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/random_walk.png}
