...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/current_signal_demos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/sucata_current_signal_demos.png}
    \caption{Exemplo de nove dos dezessete sinais de corrente em um intervalo
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/anomalous_correlation_matrix.png}
    \caption{Matriz de correlação instantânea entre séries temporais sob
    regime de anomalia.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/current_signal_acorrs.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/sucata_current_signal_acorrs.png}
    \caption{Exemplo de autocorrelação de nove dos dezessete sinais de corrente
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/kalman_trend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/autocorrelation_peak_example.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/seasonal_pattern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/decomposition.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/residuals.png}
...
e~\ref{fig:anomalous_decomposition}. Observamos que, conforme desejado, a presença da
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/anomalous_decomposition.png}
    \caption{Visualização de decomposição linear de um trecho de oito
    minutos de sinal em regime de anomalia. A linha horizontal vermelha
    indica o momento de ocorrência da falha.}
    \label{fig:anomalous_decomposition}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/anomalous_residuals.png}
    \caption{Visualização de resíduos de um segmento de oito minutos de sinal
...
O processo anterior foi realizado de forma univariada e os resultados
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/multiple_decomp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/psd_comparison_signals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/psd_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/spectrogram_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/max_spectrogram_comparison.png}
